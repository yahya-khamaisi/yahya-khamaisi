...
**Full-Stack AI Engineer** · Dubai, UAE
...
| Area | Tools |
| --- | --- |
| **Backend & APIs** | Python · FastAPI · Flask · Node.js · Express · NestJS · Azure Functions |
| **AI & Retrieval** | Agentic AI · RAG · LangChain · OpenAI · Azure AI Foundry · Milvus · ChromaDB |
| **Data & Cloud** | PostgreSQL · MongoDB · Redis · Docker · Azure · CI/CD · schema & query tuning |
| **Full Stack & Product** | React · Next.js · TypeScript · admin portals · embeddable widgets · RBAC / SSO |
| **Research** | TensorFlow · Sionna · YOLOv8 / computer vision · Monte Carlo experiment automation |
...
- **Review and Enhancement of VoIP Security** — Journal of Telecommunications and the Digital Economy, 2024
- **Ethics and its role in the future of AI development** — ICFDT, 2023
